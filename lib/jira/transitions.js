...
define([
  ...
  var transitions = {
    ...
    move: function (issue, transitionName) {
      var that = this;
    ...
    start: function (issue) {
      return this.move(issue, config.options["jira_start"]["status"]);
    },

    start: function (issue) {
      return this.move(issue, config.options["jira_stop"]["status"]);
    },

    analysis: function (issue) {
      return this.move(issue, "Start Analysis");
    },

    analysisComplete: function (issue) {
      return this.move(issue, "Analysis Complete");
    },

    assignDeveloper: function (issue) {
      return this.move(issue, "Developer Assigned");
    },

    codeReview: function (issue) {
      return this.move(issue, "Code Review");
    },

    startReview: function (issue) {
      return this.move(issue, "Start Review");
    },

    review_passed: function (issue) {
      return this.move(issue, "Review Passed");
    },

    deploy: function (issue) {
      return this.move(issue, "Deployed");
    },

    review: function (issue) {
      return this.move(issue, config.options["jira_review"]["status"]);
    },
